 ...
 */
public class VolleyLog extends com.android.volley.VolleyLog{
    ...
    static class MarkerLog {
        ...
        public synchronized void add(String name, long threadId) {
            ...
            mMarkers.add(new MarkerLog.Marker(name, threadId, SystemClock.elapsedRealtime()));
        }
        ...
        public synchronized void finish(String header) {
            ...
            for (MarkerLog.Marker marker : mMarkers) {
